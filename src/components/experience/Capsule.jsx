...
export default function Capsule({index, val, vals, setVals, display, setDisplay, cancelField}) {
  ...
  return (
    <div className="capsule">
      ...
      {val.display && display && <NewExperience index={index} val={val} vals={vals} setVals={setVals} setDisplay={setDisplay} temporaryClickedExperience={temporaryClickedExperienceRef.current} cancelField={cancelField} />}
    </div>
  )
}